...
namespace VoV.Data.Migrations
{
    ...
    [Migration("20230915065124_MeetingAndEmpCodeOfUserTable")]
    partial class MeetingAndEmpCodeOfUserTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoV.Data.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("VoV.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CompanyId = new Guid("cf1d1c0c-2f49-4941-bda0-8f32232571b1"),
                            CreatedById = new Guid("eb041919-5dd5-47bb-afdb-955df07b68a1"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "sentient2008@gmail.com",
            ...
            modelBuilder.Entity("VoV.Data.Entities.Message", b =>
                {
                    b.HasOne("VoV.Data.Entities.ClientBusinessUnit", "ClientBusinessUnit")
                        ...
                        .HasForeignKey("ClientBusinessUnitId")
                        .IsRequired()
                        .HasConstraintName("FK_Message_ClientBusinessUnit");

                    b.HasOne("VoV.Data.Entities.ClientEmployee", "ClientEmployee")
                        .WithMany("Messages")
                        .HasForeignKey("ClientEmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_Message_ClientEmployee");
                    ...
                    b.HasOne("VoV.Data.Entities.User", "CompanyUser")
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_Message_CompanyUser");
