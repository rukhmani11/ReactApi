...
namespace VoV.Data.Migrations
{
    ...
    [Migration("20230918063120_MeetingRelated6Tables")]
    partial class MeetingRelated6Tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoV.Data.Entities.MeetingObservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("VoV.Data.Entities.MeetingOther", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("MeetingOthers");
                });

            modelBuilder.Entity("VoV.Data.Entities.MeetingOtherMatter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("OtherMatterStatus")
                        .IsRequired()
                        .HasMaxLength(1)
                        .HasColumnType("nvarchar(1)");
            ...
            modelBuilder.Entity("VoV.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CompanyId = new Guid("cf1d1c0c-2f49-4941-bda0-8f32232571b1"),
                            CreatedById = new Guid("15c07de0-0499-404e-828f-5197def3f190"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "sentient2008@gmail.com",
            ...
            modelBuilder.Entity("VoV.Data.Entities.MeetingCompanyAttendee", b =>
                {
                    b.HasOne("VoV.Data.Entities.ClientEmployee", "ClientEmployee")
                        ...
                        .HasForeignKey("ClientEmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_MeetingCompanyAttendee_ClientEmployee");
            ...
            modelBuilder.Entity("VoV.Data.Entities.MeetingObservation", b =>
                {
                    b.HasOne("VoV.Data.Entities.User", "AssignedToUser")
                        ...
                        .HasConstraintName("FK_MeetingObservation_User");

                    b.HasOne("VoV.Data.Entities.CompanyObservation", "CompanyObservation")
                        .WithMany("MeetingObservations")
                        .HasForeignKey("CompanyObservationId")
                        .IsRequired()
                        .HasConstraintName("FK_MeetingObservation_CompanyObservation");

                    b.HasOne("VoV.Data.Entities.Meeting", "Meeting")
                        .WithMany("MeetingObservations")
                        .HasForeignKey("MeetingId")
                        .IsRequired()
                        .HasConstraintName("FK_MeetingObservation_Meeting");
            ...
            modelBuilder.Entity("VoV.Data.Entities.Meeting", b =>
                {
                    ...
                    b.Navigation("MeetingOtherMatters");

                    b.Navigation("MeetingOthers");
