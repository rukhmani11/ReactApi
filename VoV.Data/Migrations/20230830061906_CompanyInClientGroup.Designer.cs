...
namespace VoV.Data.Migrations
{
    ...
    [Migration("20230830061906_CompanyInClientGroup")]
    partial class CompanyInClientGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoV.Data.Entities.ClientEmployee", b =>
                {
                    ...
                    b.Property<Guid?>("ClientBusinessUnitId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ClientBusinessUnitId1");
            ...
            modelBuilder.Entity("VoV.Data.Entities.ScheduleMeeting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("VoV.Data.Entities.ScheduleMeetingObservationDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("ScheduleMeetingObservationDetails");
                });

            modelBuilder.Entity("VoV.Data.Entities.ScheduleMeetingOpportunityDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("ScheduleMeetingOpportunityDetails");
                });

            modelBuilder.Entity("VoV.Data.Entities.ScheduleMeetingRiskDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("ScheduleMeetingRiskDetails");
                });
            ...
            modelBuilder.Entity("VoV.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CompanyId = new Guid("cf1d1c0c-2f49-4941-bda0-8f32232571b1"),
                            CreatedById = new Guid("fef51506-814c-432e-903e-389f4491c47f"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "sentient2008@gmail.com",
            ...
            modelBuilder.Entity("VoV.Data.Entities.ClientEmployee", b =>
                {
                    ...
                    b.HasOne("VoV.Data.Entities.ClientBusinessUnit", null)
                        .WithMany("ClientEmployees")
                        .HasForeignKey("ClientBusinessUnitId1");
            ...
            modelBuilder.Entity("VoV.Data.Entities.ClientFinancial", b =>
                {
                    ...
                    b.HasOne("VoV.Data.Entities.Currency", "Currency")
                        ...
                        .HasConstraintName("FK_Currency_CurrencyCode");
