...
namespace VoV.Data.Migrations
{
    ...
    [Migration("20231013094411_meetingStatusAsPrivate1.1")]
    partial class meetingStatusAsPrivate11
    {
            ...
            modelBuilder.Entity("VoV.Data.Entities.Meeting", b =>
                {
                    ...
                    b.Property<string>("MeetingStatus")
                        ...
                        .IsUnicode(false)
                        .HasColumnType("nvarchar(15)")
                        .HasComputedColumnSql("(case [MeetingStatusId] when (0) then 'Pending' when (1) then 'Submitted' when (2) then 'Approved' when (3) then 'Rejected' when (4) then 'OnHold' when (5) then 'Approved By Office' when (6) then 'Rejected By Office'  end)");
            ...
            modelBuilder.Entity("VoV.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CompanyId = new Guid("cf1d1c0c-2f49-4941-bda0-8f32232571b1"),
                            CreatedById = new Guid("4ebf832c-c7e2-4d61-943d-e77f871bc77e"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "sentient2008@gmail.com",
