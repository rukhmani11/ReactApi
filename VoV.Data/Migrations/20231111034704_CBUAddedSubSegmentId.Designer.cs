...
namespace VoV.Data.Migrations
{
    ...
    [Migration("20231111034704_CBUAddedSubSegmentId")]
    partial class CBUAddedSubSegmentId
    {
            ...
            modelBuilder.Entity("VoV.Data.Entities.ClientBusinessUnit", b =>
                {
                    ...
                    b.Property<Guid?>("BusinessSubSegmentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BusinessSubSegmentId");
            ...
            modelBuilder.Entity("VoV.Data.Entities.Meeting", b =>
                {
                    ...
                    b.Property<Guid?>("VisitedClientBusinessUnitId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("VisitedClientEmployeeId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("VisitedCompanyUserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("VisitedClientBusinessUnitId");

                    b.HasIndex("VisitedClientEmployeeId");

                    b.HasIndex("VisitedCompanyUserId");
            ...
            modelBuilder.Entity("VoV.Data.Entities.MeetingObservationAndOtherMatter", b =>
                {
                    ...
                    b.Property<string>("CompanyObservation")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
            ...
            modelBuilder.Entity("VoV.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CompanyId = new Guid("cf1d1c0c-2f49-4941-bda0-8f32232571b1"),
                            CreatedById = new Guid("32f9ce05-c92d-4422-8cfc-c791d1a56547"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "sentient2008@gmail.com",
            ...
            modelBuilder.Entity("VoV.Data.Entities.ClientBusinessUnit", b =>
                {
                    ...
                    b.HasOne("VoV.Data.Entities.BusinessSubSegment", "BusinessSubSegment")
                        .WithMany("ClientBusinessUnits")
                        .HasForeignKey("BusinessSubSegmentId")
                    ...
                    b.Navigation("BusinessSubSegment");
            ...
            modelBuilder.Entity("VoV.Data.Entities.Meeting", b =>
                {
                    ...
                    b.HasOne("VoV.Data.Entities.User", "CompanyUser")
                        .WithMany("MeetingsCompanyUser")
                        .HasForeignKey("CompanyUserId")
                        .IsRequired()
                        .HasConstraintName("FK_Meeting_CompanyUser");

                    b.HasOne("VoV.Data.Entities.ClientBusinessUnit", "VisitedClientBusinessUnit")
                        .WithMany("MeetingsVisitedClientBusinessUnit")
                        .HasForeignKey("VisitedClientBusinessUnitId")
                        .HasConstraintName("FK_Meeting_VisitedClientBusinessUnit");

                    b.HasOne("VoV.Data.Entities.ClientEmployee", "VisitedClientEmployee")
                        .WithMany("MeetingsVisitedClientEmployee")
                        .HasForeignKey("VisitedClientEmployeeId")
                        .HasConstraintName("FK_Meeting_VisitedClientEmployee");

                    b.HasOne("VoV.Data.Entities.User", "VisitedCompanyUser")
                        .WithMany("MeetingsVisitedCompanyUser")
                        .HasForeignKey("VisitedCompanyUserId")
                    ...
                    b.Navigation("VisitedClientBusinessUnit");

                    b.Navigation("VisitedClientEmployee");

                    b.Navigation("VisitedCompanyUser");
                });
            ...
            modelBuilder.Entity("VoV.Data.Entities.ClientBusinessUnit", b =>
                {
                    ...
                    b.Navigation("MeetingsClientBusinessUnit");

                    b.Navigation("MeetingsVisitedClientBusinessUnit");
                });
            ...
            modelBuilder.Entity("VoV.Data.Entities.ClientEmployee", b =>
                {
                    ...
                    b.Navigation("MeetingsClientEmployee");

                    b.Navigation("MeetingsVisitedClientEmployee");
                });
            ...
            modelBuilder.Entity("VoV.Data.Entities.User", b =>
                {
                    ...
                    b.Navigation("MeetingsCompanyUser");

                    b.Navigation("MeetingsVisitedCompanyUser");
                });
